...
class ContextAnalyzer:
    ...
    def classify_with_relative_energy(self, characteristics: Dict[str, Any],
                                    all_energies: List[float], current_index: int) -> str:
    ...
    def apply_rb_pairing_and_verse_recovery(self, base_type: str,
                                          characteristics: Dict[str, Any],
                                          previous_sections: List[Dict[str, Any]],
                                          next_sections: List[Dict[str, Any]]) -> str:
        ...
        # Verse recovery: isolated high-energy sections might be verses
            ...
            if (current_energy > 0.6 and 
                prev_energy < current_energy * 0.7 and 
                next_energy < current_energy * 0.7):
    ...
    def apply_context_rules(self, base_type: str, previous_sections: List[Dict[str, Any]],
                          characteristics: Dict[str, Any], section_index: int) -> str:
    ...
    def _is_energy_building_enhanced(self, prev_section: Dict[str, Any],
                                   current_characteristics: Dict[str, Any]) -> bool:
        ...
        prev_rhythm = prev_section.get('rhythmic_density', 0.0)
        current_rhythm = current_characteristics.get('rhythmic_density', 0.0)
        rhythm_increase = current_rhythm > prev_rhythm * 1.05
    ...
    def detect_verse_repetition(self, similarity_matrix: np.ndarray,
    ...
    def classify_section_type_with_enhanced_context(self, characteristics: Dict[str, Any],
                                                  previous_sections: List[Dict[str, Any]],
    ...
    def classify_section_type_with_context(self, characteristics: Dict[str, Any],
                                         previous_sections: List[Dict[str, Any]],
        ...
        complexity = characteristics.get('spectral_complexity', 0.0)
        harmonic_content = characteristics.get('harmonic_content', 0.0)
        rhythmic_density = characteristics.get('rhythmic_density', 0.0)
