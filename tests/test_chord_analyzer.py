...
class TestChordProgressionAnalyzer(unittest.TestCase):
    ...
    def test_analyze_progression(self):
        ...
        # Check required keys
        required_keys = [
            'main_progression', 'progression_pattern', 'harmonic_rhythm',
            'chord_complexity', 'unique_chords', 'chord_changes'
        ]
    ...
    def test_analyze_complete(self):
        ...
        required_keys = [
            'chords', 'main_progression', 'progression_pattern',
            'harmonic_rhythm', 'chord_complexity', 'unique_chords',
            'chord_changes', 'functional_analysis', 'modulations',
