...
from src.bpm_detector.auto_parallel import AutoParallelConfig, SystemMonitor, ParallelConfig
...
class TestSmartParallelAudioAnalyzer(unittest.TestCase):
    ...
    def test_fallback_to_sequential(self, mock_should_use_parallel):
        ...
        with patch.object(analyzer.__class__.__bases__[0], 'analyze_file') as mock_parent:
            ...
            result = analyzer.analyze_file(self.test_file, comprehensive=True)
...
class TestAdvancedParallelFeatures(unittest.TestCase):
    ...
    def test_memory_management(self):
        ...
        limited_analyzer = SmartParallelAudioAnalyzer(
            auto_parallel=True,
            max_workers=2
        )
    ...
    def test_detailed_progress_tracking(self):
        ...
        from src.bpm_detector.progress_manager import ProgressManager, DetailedProgressDisplay
