...
class TestSimilarityEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_results = {
            'basic_info': {'bpm': 120.0, 'key': 'C Major', 'duration': 180.0},
            'chord_progression': {
                'harmonic_rhythm': 2.0,
            ...
            'melody_harmony': {
                ...
                'consonance': {'consonance_level': 0.8},
            },
            'dynamics': {
                'dynamic_range': {
                ...
                'loudness': {'average_loudness_db': -15.0, 'perceived_loudness': 0.7},
                'overall_energy': 0.6,
                'energy_variance': 0.3,
                'energy_distribution': {
                    'low_freq_ratio': 0.3,
    ...
    def test_generate_similarity_matrix(self):
        ...
        vectors = [np.random.rand(20), np.random.rand(20), np.random.rand(20)]
