...
class TestSectionProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_sections = [
            ...
            {
                'start_time': 50.0, 'end_time': 70.0, 'type': 'verse',
                'confidence': 0.85, 'characteristics': {'energy': 0.5, 'spectral_complexity': 0.6}
            },
            {
                'start_time': 70.0, 'end_time': 90.0, 'type': 'chorus',
                'confidence': 0.9, 'characteristics': {'energy': 0.9, 'spectral_complexity': 0.8}
            },
            {
                'start_time': 90.0, 'end_time': 110.0, 'type': 'bridge',
                'confidence': 0.7, 'characteristics': {'energy': 0.6, 'spectral_complexity': 0.7}
            },
            {
                'start_time': 110.0, 'end_time': 130.0, 'type': 'chorus',
                'confidence': 0.92, 'characteristics': {'energy': 0.9, 'spectral_complexity': 0.8}
            },
            {
                'start_time': 130.0, 'end_time': 140.0, 'type': 'outro',
                'confidence': 0.75, 'characteristics': {'energy': 0.2, 'spectral_complexity': 0.3}
            }
        ]
    ...
    def test_form_analysis_edge_cases(self):
        ...
        minimal_sections = [
            {'type': 'verse', 'start_time': 0, 'end_time': 60}
        ]
    ...
    def test_bdB_merging_strict_tolerance(self):
        ...
        test_sections = [
            ...
            {'type': 'instrumental', 'start_time': 15.0, 'end_time': 31.2, 'duration': 16.2,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},  # 16.2s > 14.7s + 1.47s
            {'type': 'chorus', 'start_time': 31.2, 'end_time': 46.2, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'chorus', 'start_time': 46.2, 'end_time': 61.2, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 61.2, 'end_time': 75.0, 'duration': 13.8,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},  # 13.8s < 14.7s + 1.47s
    ...
    def test_max_chorus_length_limit(self):
        ...
        test_sections = [
            {'type': 'chorus', 'start_time': 0.0, 'end_time': 15.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 15.0, 'end_time': 29.0, 'duration': 14.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},  # Within 8-bar limit
    ...
    def test_acceptable_chorus_length_merging(self):
        ...
        test_sections = [
            {'type': 'chorus', 'start_time': 0.0, 'end_time': 10.0, 'duration': 10.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 10.0, 'end_time': 18.0, 'duration': 8.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},  # Within 8-bar limit
            {'type': 'chorus', 'start_time': 18.0, 'end_time': 28.0, 'duration': 10.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
    ...
    def test_yoru_ni_kakeru_super_long_chorus_prevention(self):
        ...
        yoru_ni_kakeru_pattern = [
            {'type': 'chorus', 'start_time': 73.0, 'end_time': 88.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 88.0, 'end_time': 102.0, 'duration': 14.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},
            {'type': 'chorus', 'start_time': 102.0, 'end_time': 117.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 117.0, 'end_time': 132.0, 'duration': 15.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},
            {'type': 'chorus', 'start_time': 132.0, 'end_time': 147.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
        ]
        ...
        for i, section in enumerate(processed):
            if section['type'] == 'chorus':
                self.assertLessEqual(section['duration'], max_allowed + 1.0,  # Small tolerance
    ...
    def test_yoru_ni_kakeru_second_long_chorus_pattern(self):
        ...
        second_pattern = [
            {'type': 'chorus', 'start_time': 205.0, 'end_time': 220.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 220.0, 'end_time': 234.0, 'duration': 14.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},
            {'type': 'chorus', 'start_time': 234.0, 'end_time': 249.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 249.0, 'end_time': 261.0, 'duration': 12.0,
             'ascii_label': 'Kansou', 'energy_level': 0.5, 'complexity': 0.5},
        ]
        ...
        for section in processed:
            if section['type'] == 'chorus':
                self.assertLessEqual(section['duration'], max_allowed + 1.0,
    ...
    def test_vocal_presence_detection(self):
        ...
        vocal_ratio_vocal = self.processor._detect_vocal_presence(
            y_vocal, sr, 0.0, 5.0
        )
    ...
    def test_yoru_ni_kakeru_instrumental_restoration(self):
        ...
        self.assertLessEqual(len(processed), len(yoru_pattern),
                           "Should reduce or maintain section count")
        ...
        for section in processed:
            self.assertLessEqual(section['duration'], 60.0,
    ...
    def test_ascii_label_consistency(self):
        ...
        test_sections = [
            {'type': 'verse', 'start_time': 0.0, 'end_time': 15.0, 'duration': 15.0,
             'ascii_label': 'verse', 'energy_level': 0.5, 'complexity': 0.5},  # Inconsistent
            {'type': 'pre_chorus', 'start_time': 15.0, 'end_time': 30.0, 'duration': 15.0,
             'ascii_label': 'pre_chorus', 'energy_level': 0.6, 'complexity': 0.6},  # Inconsistent
            {'type': 'chorus', 'start_time': 30.0, 'end_time': 45.0, 'duration': 15.0,
             'ascii_label': 'chorus', 'energy_level': 0.8, 'complexity': 0.7},  # Inconsistent
        ]
    ...
    def test_processing_order_pairing_before_suppression(self):
        ...
        test_sections = [
            ...
            {'type': 'pre_chorus', 'start_time': 30.0, 'end_time': 45.0, 'duration': 15.0,
             'ascii_label': 'B-melo', 'energy_level': 0.6, 'complexity': 0.6},
            {'type': 'verse', 'start_time': 45.0, 'end_time': 60.0, 'duration': 15.0,
    ...
    def test_jpop_structure_optimization(self):
        ...
        jpop_sections = [
            ...
            {'type': 'pre_chorus', 'start_time': 14.0, 'end_time': 29.0, 'duration': 15.0,
             'ascii_label': 'B-melo', 'energy_level': 0.6, 'complexity': 0.6},
            {'type': 'verse', 'start_time': 29.0, 'end_time': 44.0, 'duration': 15.0,
             'ascii_label': 'A-melo', 'energy_level': 0.4, 'complexity': 0.5},
            {'type': 'pre_chorus', 'start_time': 44.0, 'end_time': 58.0, 'duration': 14.0,
             'ascii_label': 'B-melo', 'energy_level': 0.6, 'complexity': 0.6},
            {'type': 'pre_chorus', 'start_time': 58.0, 'end_time': 73.0, 'duration': 15.0,
             'ascii_label': 'B-melo', 'energy_level': 0.6, 'complexity': 0.6},
            {'type': 'chorus', 'start_time': 73.0, 'end_time': 88.0, 'duration': 15.0,
             'ascii_label': 'Sabi', 'energy_level': 0.8, 'complexity': 0.7},
            {'type': 'instrumental', 'start_time': 88.0, 'end_time': 102.0, 'duration': 14.0,
