...
class TestMelodyAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.vibrato_audio = np.sin(2 * np.pi * (vibrato_freq + vibrato_depth * np.sin(2 * np.pi * vibrato_rate * t)) * t)
    ...
    def test_analyze_melodic_range(self):
        ...
        # Check required fields
        expected_fields = ['range_semitones', 'range_octaves', 'lowest_note', 'highest_note', 'vocal_range_classification']
        for field in expected_fields:
