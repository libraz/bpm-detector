...
from bpm_detector import (
    AudioAnalyzer, BPMDetector, KeyDetector,
    ChordProgressionAnalyzer, StructureAnalyzer, RhythmAnalyzer,
    TimbreAnalyzer, MelodyHarmonyAnalyzer, DynamicsAnalyzer,
    SimilarityEngine
)
...
def similarity_analysis_example():
    ...
    similarity_matrix = similarity_engine.generate_similarity_matrix(
        track_features, method='weighted'
    )
